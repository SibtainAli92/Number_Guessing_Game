...
export default function NumberGuessing(): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-sky-800 to-black">
      {/* Main container for the game */}
      <div className="bg-sky-700 rounded-2xl shadow-lg [box-shadow:0px_0px_30px_white] p-8 w-full max-w-md font-[math]">
        {/* Title of the game */}
        ...
        {!gameStarted && (
          <div className="flex justify-center mb-4">
            ...
            <Button
              ...
              className="bg-sky-950 hover:bg-sky-900 text-white  py-2 px-4 rounded"
            >
              Start Game
            </Button>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-center mb-4">
              ...
              <Input
                ...
                className="bg-gray-100 border placeholder:text-black [box-shadow:0px_0px_20px_black] border-gray-300 rounded-lg py-2 px-4 w-full max-w-xs"
                placeholder="Enter your guess"
              />
              {/* Button to submit the guess */}
              <Button
                onClick={handleGuess}
                className="bg-sky-950 hover:bg-sky-900 text-white font-bold py-2 px-4 rounded ml-4"
              >
                Guess
              </Button>
            </div>
        ...
        {gameOver && (
          <div>
            <div className="text-center mb-4 text-red-950">
              {/* Game over message */}
            ...
            <div className="flex justify-center">
              ...
              <Button
                ...
                className="bg-red-950 hover:bg-red-800 text-white py-2 px-4 rounded"
              >
                Try Again
              </Button>
            </div>
